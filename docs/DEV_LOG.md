...
- Confirm the daily schedule summary includes client names for booking rows and excludes phone numbers, comments, internal notes, booking source, and prices.
