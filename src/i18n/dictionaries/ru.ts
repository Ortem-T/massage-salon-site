  ...
  services: {
    ...
    categoryPages: {
      ...
      permanent_makeup: {
        ...
        description: "Пудровые брови, губы и межресничная линия с мягким premium-подходом.",
        seoTitle: "Перманентный макияж в Нови-Саде | Raine",
        seoDescription: "Перманентный макияж Raine в Нови-Саде: пудровые брови, губы и межресничная линия."
      }
    },
    permanentMakeupGroups: {
      brows: "Брови",
      lips: "Губы",
      lashLine: "Межресничная линия",
