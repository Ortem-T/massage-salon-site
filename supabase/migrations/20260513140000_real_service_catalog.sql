...
translation_rows(slug, locale, name, short_description) as (
  values
    ...
    ('facial-microcurrents', 'sr', 'Mikrotalasna terapija lica', 'Aparatna procedura za tonus kože lica, blagi lifting efekat i svežiji izgled.'),
    ...
    ('face-course-6-treatments', 'sr', 'Kurs od 6 tretmana', 'Kombinovani kurs od 6 tretmana: 3 masaže lica i 3 mikrotalasne procedure. Termini narednih dolazaka dogovaraju se individualno.'),
